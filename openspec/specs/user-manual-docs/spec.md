...
- **THEN** they understand how to navigate the VisuSpace channel, manage pages, configure page metadata, and preview/publish pages

#### Scenario: Organizer views AI Chatbox and Assistant guides
- **WHEN** an organizer accesses the AI assistant section of the manual
- **THEN** they SHALL find detailed specifications for the AI Conference Chatbox and how it functions for C-side users
