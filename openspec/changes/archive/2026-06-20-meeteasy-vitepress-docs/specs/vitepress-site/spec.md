...
The wiki repository SHALL contain a VitePress documentation site with root-level `package.json`, VitePress configuration under `src/.vitepress/`, content under `src/zh/` and `src/en/`, and npm scripts for development, build, and preview.
