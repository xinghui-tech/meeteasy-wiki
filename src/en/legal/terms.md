...
MeetEasy is a multi-tenant SaaS platform for conference management, providing:

- Conference creation, agenda management, and content delivery
- Attendee registration, check-in, and seating
- AI-powered attendee assistance
- Analytics and share tracking
- Visual microsite builder (VisuSpace)
- Plugin extensibility

The Service is provided through Admin, Console, MeetApp, VisuSpace, and WeChat mini program applications.
...
- One person may not maintain more than one account unless authorized
- We reserve the right to refuse or terminate accounts at our discretion

## 4. User Content & Data Ownership

- **Organizer content** — Conference data, forms, microsite pages, and uploaded materials belong to the organizing tenant
- **Attendee data** — Registration submissions belong to the attendee, shared with the organizer for event purposes
- **Platform data** — Usage analytics and aggregated statistics may be used by the Company for service improvement
...
- Upload illegal, harmful, threatening, or infringing content
...
- Abuse AI features (prompt injection, generating harmful content)
- Resell or sublicense the Service without authorization
- Reverse engineer or decompile the Service

## 6. Paid Services

[TBD — Pricing, billing, and refund policy to be defined when paid tiers are launched.]
...
You agree to indemnify and hold harmless the Company from claims arising from your use of the Service, your content, or your violation of these Terms.

## 11. Termination

- You may stop using the Service and delete your account at any time
- We may suspend or terminate your access for Terms violations
- Upon termination, your right to use the Service ceases; data retention follows our Privacy Policy
- Provisions that by nature should survive termination (liability, indemnification) remain in effect
